const users = [
    ...
    { name: "周丽", gender: "female", department: "绘画", grade: "2023级", research: "数字绘画", interests: "传统国画、新媒体艺术", skills: "数字绘画软件、传统绘画技法", needs: "寻找对AI辅助创作感兴趣的同学", details: "我的研究重点是探索人工智能辅助创作在传统国画中的应用，寻求传统与现代的融合。我正在开发一种AI系统，它能够学习传统国画的笔法和构图，辅助艺术家创作出兼具传统韵味和现代特色的作品。" },
