...
const activities = [
    ...
    {
        title: "AI搜索与文献综述培训工作坊",
        type: "工作坊",
        date: "2024-10-08",
        briefIntro: "组织学习利用最新的AI工具完成学术写作中的搜索和综述内容",
        description: "在本次短期工作坊中，李策分享了目前较为常用的学术搜索引擎，并且演示了如何与对话式AI协作完成学术写作的综述内容",
        imageUrl: "activities/imgs/20241008act1img0.jpg",
        participants: [
            {
                name: "李策",
                briefIntro: "AI学术搜索与文献综述",
                detailedPresentation: "李策博士介绍了他常用的一系列AI学术写作工作流，主要包含文献搜索、整理，文献综述的写作",
                papers: [
                    {
                        title: "基于AI的学术搜索",
                        abstract: "常用工具包括秘塔搜索，txyz.ai，perplexity，gpt+consensus",
                        url: "metaso.cn"
                    }
                ]
            },
